...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=Kp99ZVd_-95LxFOvKJ6I8xMb; sb=SJ99ZagSTi1GxIV36xBYFKu5; dpr=2.1988937854766846; m_pixel_ratio=2; wd=360x684; fr=0UT5JrPKKvzBLQUkK..BlfZ8q.eq.AAA.0.0.BliB_Q.AWVaw29clU4',
    'dpr': '2',
...
def rcrack(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=Kp99ZVd_-95LxFOvKJ6I8xMb; sb=SJ99ZagSTi1GxIV36xBYFKu5; dpr=2.1988937854766846; m_pixel_ratio=2; wd=360x684; fr=0UT5JrPKKvzBLQUkK..BlfZ8q.eq.AAA.0.0.BliCBf.AWVLkpqhQE8',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.26"',
